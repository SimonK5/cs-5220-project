...
public:
    ...
    std::vector<std::vector<int>> get_neighbor_directions(){
        std::vector<std::vector<int>> dirn = {{1, 0}, {0, 1}, {0, -1}, {-1, 0}, {1, 1}};
        return dirn;
    }
...
public:
    ...
    int size;
    unsigned int seed; // used for pre-setting edge weights
    std::vector<Obstacle> obstacles;
    std::vector<std::vector<char>> grid;
    // std::vector<std::vector<int>> neighbor_dirns;

    AStarMap(int s, std::vector<Obstacle> obstacleList) : size(s), startX(0), startY(0), endX(0), endY(0){
        std::uniform_int_distribution<> seed_distrib(0, 1000000);
        ...
        // std::vector<std::vector<char>> initGrid = parse_maze("/global/homes/s/simonk5/cs-5220-project/mazes/maze_test_1.txt");
    ...
    std::vector<std::vector<int>> get_neighbor_directions(){
        std::vector<std::vector<int>> dirn = {{1, 0}, {0, 1}, {0, -1}, {-1, 0}, {1, 1}, {1, -1}, {-1, 1}, {-1, -1}};
        return dirn;
    }
};
